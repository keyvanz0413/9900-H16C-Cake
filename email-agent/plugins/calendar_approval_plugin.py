"""Local Calendar approval plugin with frontend and CLI approval paths."""
...
def check_calendar_approval(agent: "Agent") -> None:
    ...
    raise ValueError(
        f"Calendar tool '{tool_name}' requires approval, but no frontend connection or interactive terminal is available."
    )
